...
if (cp_module_activated('post_author_points')) {
    ...
    function cp_module_post_author_points_config_process() {
        $cp_post_author_points = (int) filter_input(INPUT_POST, 'cp_post_author_points');
    ...
    function cp_module_post_author_points_comment_add($cid) {
        ...
        if ($cdata->user_id != $pdata->post_author) {
            ...
            $wpgamify_points_core->wpg_points('post_comment', $pdata->post_author, get_option('cp_post_author_points'), $cid);
        }
    }
    ...
    function cp_module_post_author_points_comment_remove($cid) {
        ...
        if ($cdata->user_id != $pdata->post_author) {
            global $wpgamify_points_core;
            $wpgamify_points_core->wpg_points('post_comment_remove', $pdata->post_author, -get_option('cp_post_author_points'), $cid);
        }
    }
