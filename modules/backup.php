            ...
            <form name="cp_module_backup_down_form" method="post">
                ...
                <table class="form-table">
                    ...
                    <tr valign="top">
                        ...
                        <td valign="middle"><?php $users = count_users();
        echo $users['total_users']; ?></td>
                    </tr>
                    <tr valign="top">
                    ...
                    <tr valign="top">
                        ...
                        <td valign="middle">
                            <select id="cp_module_backup_up_form_match" name="cp_module_backup_up_form_match" style="width:200px;">
                                <option value="id"<?php echo $cp_module_backup_up_form_match == 'id' ? ' selected' : ''; ?>><?php _e('User ID', 'cp'); ?></option>
                                <option value="login"<?php echo $cp_module_backup_up_form_match == 'login' ? ' selected' : ''; ?>><?php _e('Username', 'cp'); ?></option>
                                <option value="email"<?php echo $cp_module_backup_up_form_match == 'email' ? ' selected' : ''; ?>><?php _e('Email Address', 'cp'); ?></option>
                            </select>
                        </td>
                    </tr>
                </table>
